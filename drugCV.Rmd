...
# googleSheetId <- "1j1wzkibgoGxyJvmYjI-fWDYvWNpW1k6sDgTFxKq7QcI"
# googlesheets4::gs4_deauth()
# drugScores2017<-read.csv("drugScores2017.csv")
# 
source("configure.R")
...
```{r AD clinicaltrials, message = FALSE, warning = FALSE}
  
ADClinicalTrials <- getADClinicalTrialsData(params$x)


if(nrow(ADClinicalTrials)>0){
...
```{r other diseases clinicaltrials, message = FALSE, warning = FALSE}
  
OtherClinicalTrials <- getOtherNeuroClinicalTrialsData(params$x)


if(nrow(OtherClinicalTrials)>0){
